...
public class Inventory extends SubWindow{
    ...
    public void draw(Graphics g){
        drawSubWindowXY(g, 25, 25, Game.WIDTH/2-(Game.MAP_RESOLTION_16*Game.SCALE), Game.HEIGHT-50); //i dont understan this fucking hell why is it not -50
        invWidth = Game.WIDTH/2-(Game.MAP_RESOLTION_16*Game.SCALE)-25;
